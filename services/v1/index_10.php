...
$app->post('/get_plot','authenticateUser', function () use ($app) {
    ...
    {
        $plot_array = array();
        $res_plot=$db->get_plot_no($result_estate['taluka'],$result_estate['industrial_estate'],$result_estate['area_id']);
...
$app->post('/get_floor','authenticateUser', function () use ($app) {
    ...
    $res_plot=$db->get_plot_floor($result_estate['taluka'],$result_estate['industrial_estate'],$result_estate['area_id'],$plot_no,$road_no);
...
$app->post('/get_road_plot','authenticateUser', function () use ($app) {
    ...
    $res_plot=$db->get_road_plot($result_estate['taluka'],$result_estate['industrial_estate'],$result_estate['area_id']);
...
$app->post('/add_plot','authenticateUser', function () use ($app) {
    ...
    $result_plot_search=$db->get_plot_floor($result_estate['taluka'],$result_estate['industrial_estate'],$result_estate['area_id'],$plot_no,$road_no);
...
$app->post('/add_followup','authenticateUser', function () use ($app) {
    ...
    //{"followup_text" : "", "inq_id" : "", "source" : "", "next_action" : "", "user_id" : "", "next_datetime" : "", "summary" : "", "reason" : "", "remark" : ""}
