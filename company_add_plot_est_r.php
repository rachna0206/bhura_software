        ...
        <table class="table table-hover" id="table_id">
          ...
          <tbody class="table-border-bottom-0">
            ...
            <tr>
              ...
              <td>
                <a href="javascript:editdata('<?php echo $data["estate_id"]?>','<?php echo $data["rawdata_id"]?>','<?php echo base64_encode($data["state"]) ?>','<?php echo base64_encode($data["city"]) ?>','<?php echo base64_encode($data["taluka"]) ?>','<?php echo base64_encode($data["area"]) ?>','<?php echo base64_encode($data["ind_estate"]) ?>','<?php echo base64_encode($data["firm_name"]) ?>','<?php echo $user_id ?>','<?php echo base64_encode($result_status["stage"]) ?>');"><i class="bx bx-edit-alt me-1"></i> </a>
              </td>
            </tr>
            <?php
                $i++;
...
<script type="text/javascript">
  ...
  function editdata(estate_id,rawdata_id,state,city,taluka,area,ind_estate,firm_name,user_id,status) {
