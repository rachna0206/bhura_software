            ...
            <div id="select_estate_first_div" <?php echo (isset($selecttype_est) && $selecttype_est=="select_estate_first")?"":"hidden"?>>
              <div class="mb-3">
                ...
                <!-- <select name="industrial_estate_id_est" id="industrial_estate_id_est" class="form-control" onchange="getCompanyName(this.value)" <?php echo (isset($selecttype_est) && $selecttype_est=="select_estate_first")?"required":"" ?>>
                  ...
                  <select name="industrial_estate_id_est" id="industrial_estate_id_est" class="form-control"  <?php echo (isset($selecttype_est) && $selecttype_est=="select_estate_first")?"required":"" ?>>
                    <option value="">Select Industrial Estate</option>
              <?php
              ...
              <div class="mb-3">
                ...
                <select name="rawdata_id_est" id="rawdata_id_est" onchange="get_companyStatus(this.value)" class="form-control" <?php echo (isset($selecttype_est) && $selecttype_est=="select_estate_first")?"required":"" ?> readonly>
