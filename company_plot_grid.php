...
<div class="container">
    ...
    <?php if($firm_name!=""){ ?>
        <div class="mb-3 col-md-3">
            <label class="form-label" for="basic-default-fullname">Firm Name : <?php echo $firm_name ?></label>
        </div>
    <?php } if($gst_no!=""){ ?>
        <div class="mb-3 col-md-3">
            <label class="form-label" for="basic-default-fullname">GST NO. : <?php echo $gst_no ?></label>
        </div>
    <?php } if($area!=""){ ?>
        <div class="mb-3 col-md-3">
            <label class="form-label" for="basic-default-fullname">Area : <?php echo $area ?></label>
        </div>
    <?php } if($ind_estate!=""){ ?>
        <div class="mb-3 col-md-3">
            <label class="form-label" for="basic-default-fullname">Industrial Estate : <?php echo $ind_estate ?></label>
        </div>
    <?php } if($status!=""){ ?>
        <div class="mb-3 col-md-3">
            <label class="form-label" for="basic-default-fullname">Status : <?php echo $status ?></label>
        </div>
    <?php } if($plot_status!=""){ ?>
        <div class="mb-3 col-md-3">
            <label class="form-label" for="basic-default-fullname">Plot Status : <?php echo $plot_status ?></label>
        </div>
    <?php } ?>
    </div>
